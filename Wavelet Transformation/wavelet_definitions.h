 ...
 * @todo    finished so far, more wavelet filter definitions can be added here
 *
 * This header file defines only the orthogonal quadrature mirror filters variables.
...
#ifndef CLAUER_MATH_WAVELET_DEFINITIONS
#define CLAUER_MATH_WAVELET_DEFINITIONS
...
/// define here the basic floating point for the transformation operations
#define real double
...
/**
 * This stuct defines the periodized conjugate quadrature filter
 */
typedef struct {
...
/**
 * Definition of the Beylkin 18 wavelet
 */
//@{
 static real
  b18soqf[18] = {
...
/**
 * Definition of the Coifman 6 wavelet
 */
//@{

 static real
  c06soqf[6] = {
    ((SR15-3.0)/32.0)*SR2,	/*  3.85807777478867490E-02, */
    ((1.0-SR15)/32.0)*SR2,	/* -1.26969125396205200E-01, */
    ((3.0-SR15)/16.0)*SR2,	/* -7.71615554957734980E-02, */
    ((SR15+3.0)/16.0)*SR2,	/*  6.07491641385684120E-01, */
    ((SR15+13.0)/32.0)*SR2,	/*  7.45687558934434280E-01, */
    ((9.0-SR15)/32.0)*SR2	  /*  2.26584265197068560E-01  */
    };
static int
  c06salpha = 0,
  c06somega = 5;
static real
  c06doqf[6] = {
    ...
    (-(SR15+13.0)/32.0)*SR2,/* -7.45687558934434280E-01, */
    ((SR15+3.0)/16.0)*SR2,	/*  6.07491641385684120E-01, */
    ((SR15-3.0)/16.0)*SR2,	/*  7.71615554957734980E-02, */
    ((1.0-SR15)/32.0)*SR2,	/* -1.26969125396205200E-01, */
    ((3.0-SR15)/32.0)*SR2,	/*  3.85807777478867490E-02  */
  };
static int
  c06dalpha = 0,
  c06domega = 5;
...
/**
 * Definition of the Coifman 12 wavelet
 */
//@{
...
/**
 * Definition of the Coifman 18 wavelet
 */
//@{
...
/**
 * Definition of the Coifman 24 wavelet
 */
//@{
...
/**
 * Definition of the Coifman 30 wavelet
 */
//@{
...
/**
 * Definition of the Daubechies 2 wavelet
 */
//@{
...
/**
 * Definition of the Daubechies 4 wavelet
 */
//@{
...
/**
 * Definition of the Daubechies 6 wavelet
 */
//@{
...
/**
 * Definition of the Daubechies 8 wavelet
 */
//@{
...
/**
 * Definition of the Daubechies 12 wavelet
 */
//@{
...
/**
 * Definition of the Daubechies 14 wavelet
 */
//@{
...
/**
 * Definition of the Daubechies 16 wavelet
 */
//@{
...
/**
 * Definition of the Daubechies 18 wavelet
 */
//@{
...
/**
 * Definition of the Daubechies 20 wavelet
 */
//@{
...
/**
 * Definition of the Vaidyanathan 24 wavelet
 */
//@{
...
#endif // CLAUER_MATH_WAVELET_DEFINITIONS
