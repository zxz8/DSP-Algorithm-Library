...
public static void generateWaveFile(RefObject<String> fileName)
{
	...
	//*
	// * This simple test Program illustrate the usage of the zaho-atlas-mark-distribution algorithmus.
	// 
...
//ORIGINAL LINE: void generateWaveFile(byte* fileName, boolean save = false)
	public static void generateWaveFile(RefObject<String> fileName, boolean save)
	{
	 // open the test signal
	  ...
	  System.out.print("\n");
	  double[][] zamd = clauer.math.ZahoAtlasMarksDistribution.calculateZahoAtlasMarksDistribution(signal, length, resolution);
	  ...
	  // plot the result
	  clauer.io.DataPlotter.simple3DPlot (zamd, length, resolution, 0.0, (double)(length)/(double)(sampleRate), 0.0, sampleRate/2/DefineConstantsTest.DOWNNSCALING_FACTOR, save, false, false, "Zaho-Atlas-Marks-Distribution",fileName.argvalue, infoString1, infoString2,"Contour-ZAMD.png");
	  //clauer::io::DataPlotter::extended3DPlot(zamd, length, resolution, 0.0, static_cast<double>(length)/static_cast<double>(sampleRate), 0.0, sampleRate/2/DOWNNSCALING_FACTOR, save, true, false, "Zaho-Atlas-Marks-Distribution",fileName, infoString1, infoString2,"Surface-ZAMD.png");
	...
	static int Main(int argc, RefObject<String[]> argv)
	{
	  ...
	  System.out.print("\n  ***************************************************************");
	  System.out.print("\n");
	  System.out.print("  *** This is the ZAHO-ATLAS_MARKS-DISTRIBUTION test function ***");
	  System.out.print("\n");
