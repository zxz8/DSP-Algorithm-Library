...
public static void generateWaveFile(RefObject<String> fileName)
{
	...
	//*
	// * This simple test Program illustrate the usage of the choi-williams distribution algorithmus.
	// 
...
//ORIGINAL LINE: void generateWaveFile(byte* fileName, boolean save = false)
	public static void generateWaveFile(RefObject<String> fileName, boolean save)
	{
	 // open the test signal
	  ...
	  System.out.print("\n");
	  double[][] cwd = clauer.math.ChoiWilliamsDistribution.calculateChoiWilliamsDistribution(signal, length, resolution);
	  ...
	  // plot the result
	  clauer.io.DataPlotter.simple3DPlot (cwd, length, resolution, 0.0, (double)(length)/(double)(sampleRate), 0.0, sampleRate/2/DefineConstantsTest.DOWNNSCALING_FACTOR, save, false, false, "Choi-Williams-Distribution",fileName.argvalue, infoString1, infoString2,"Contour-CWD.png");
	  //clauer::io::DataPlotter::extended3DPlot(cwd, length, resolution, 0.0, static_cast<double>(length)/static_cast<double>(sampleRate), 0.0, sampleRate/2/DOWNNSCALING_FACTOR, save, true , false, "Choi-Williams-Distribution",fileName, infoString1, infoString2,"Surface-CWD.png");
	...
	static int Main(int argc, RefObject<String[]> argv)
	{
	  ...
	  System.out.print("\n  ************************************************************");
	  System.out.print("\n");
	  System.out.print("  *** This is the CHOI_WILLIAMS-DISTRIBUTION test function ***");
	  System.out.print("\n");
