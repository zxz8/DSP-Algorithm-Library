...
void generateWaveFile(const char* fileName, bool save = false)
{
 // open the test signal
  ...
  // plot the result
  clauer::io::DataPlotter::simple3DPlot  (pmhd, length, resolution, 0.0, static_cast<double>(length)/static_cast<double>(sampleRate), 0.0, sampleRate/2/DOWNNSCALING_FACTOR, save, false, false, "Pseudo-Margenau-Hill-Distribution",fileName, infoString1, infoString2,"Contour-PMHD.png");
...
int main (int argc, char *argv[])
{
  // splash screen 
  std::cout << "\n  *******************************************************************" << std::endl;
  std::cout << "  *** This is the PSEUDO-MARGENAU-HILL-DISTRIBUTION test function ***" << std::endl;
