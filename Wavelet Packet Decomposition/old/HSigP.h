...
typedef struct{
   ...
   Vector cf;           /* array[1..pOrder+1] of ce9ntre freqs */
  ...
  int waveletCorr;      /* Wavelet 1=SBC  2=DCT (chris) */
}FBankInfo;
...
typedef enum {DAUBECHIES, SYMMLET, COIFLET, BEYLKIN, POLLEN, VAIDYANATHAN}wlType;
